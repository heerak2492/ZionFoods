    ...
    if (quantity > 0) {
      if (quantity === 1) {
        toast({
          ...
          description: `Added 1 ${product.name} (${weightLabel}) to your cart.`,
          duration: 2000,
        })
      } else {
        toast({
          title: "Added to cart!",
          description: `${product.name} (${weightLabel}) × ${quantity} has been added to your cart.`,
          duration: 3000,
        })
      }
    } else if (quantity < 0) {
      toast({
        ...
        description: `Removed 1 ${product.name} (${weightLabel}) from your cart.`,
        duration: 2000,
      })
    }
                ...
                <div className="p-4">
                  ...
                  <div className="mt-2">
                    <ProductQuantityControl
                      ...
                      weight="100"
                      onAdd={(quantity) => handleAddFavorite(product, quantity)}
                      buttonText="Add"
